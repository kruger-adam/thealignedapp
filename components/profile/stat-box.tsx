...
export function StatBox({ label, value, icon: Icon, className, tooltip, position = 'center' }: StatBoxProps) {
  ...
  // Position classes for tooltip (now appearing above)
  ...
  return (
    ...
    >
      ...
      {showTooltip && (
        <div className={cn(
          "absolute bottom-full mb-2 z-50 w-max max-w-[140px] px-2.5 py-1.5 bg-zinc-900 dark:bg-zinc-100 rounded-md shadow-lg",
          ...
          {/* Arrow pointing down */}
          <div className={cn(
            "absolute -bottom-1 w-2 h-2 bg-zinc-900 dark:bg-zinc-100 rotate-45",
